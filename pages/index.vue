...
// const data = await useAsyncData<RecipeResponse>("https://dummyjson.com/recipes?limit=30");

const data = ref<RecipeResponse>()

async function addTodo() {
  const todo = await $fetch<RecipeResponse>('https://dummyjson.com/recipes?limit=30', {
    method: 'GET',
  })
...
<template>
  <main>
      ...
      <div class="container flex flex-col lg:flex-row items-center py-20 gap-10">
        ...
        <div class="flex-1 order-1 lg:order-2">
          <img
            ...
            src="../assets/nuxt-course-hero.png"
            format="webp"
            densities="x1"
            alt=""
          />
    ...
    <section class="py-20 container">
      ...
      <div v-if="data" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-8">
      ...
      <p v-else class="text-xl">Ooops, something went wrong. Please try again later</p>
    </section>
  </main>
</template>
